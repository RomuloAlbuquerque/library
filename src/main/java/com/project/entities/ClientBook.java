...
public class ClientBook implements Serializable {
	...
	public ClientBook(Long id, String author, String title, String description, String publishingCompany, Integer numberPages,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ClientBook other = (ClientBook) obj;
		if (id == null) {
			if (other.id != null)
				return false;
